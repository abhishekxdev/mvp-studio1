        ...
        <div className="px-4 md:px-6 flex items-center justify-between py-3">
          ...
          <div className="hidden md:flex items-center space-x-6 ml-16">
            ...
            <a
              ...
              className="px-6 py-3 rounded-full border border-indigo-500/20 bg-[radial-gradient(35%_63%_at_50%_50%,_#6366f1_0%,_#4338ca_100%)] shadow-[inset_0_1px_3px_rgba(255,255,255,0.3),_0_4px_10px_rgba(99,102,241,0.3)] transition-all duration-300 hover:brightness-110 active:scale-[0.98] hidden md:inline-flex items-center"
            >

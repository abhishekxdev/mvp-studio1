    ...
    <section id="pricing" className="py-24 sm:py-32">
      <div className="mx-auto">
        <div className="text-left">
          ...
          <p className="mt-2 text-4xl font-helvetica font-normal tracking-tight sm:text-5xl text-left text-white">
            Choose the right plan for your needs
          </p>
        </div>
        <p className="mt-6 text-lg leading-8 text-white/80 font-helvetica text-left">
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between gap-x-4">
                  <h3 className="text-lg font-helvetica font-normal leading-8 text-white">
                    {plan.name}
                  </h3>
                </div>
                <p className="mt-4 text-sm leading-6 text-white/80 font-helvetica">{plan.description}</p>
                <p className="mt-6 flex items-baseline gap-x-1">
                  <span className="text-4xl font-helvetica font-normal tracking-tight text-white">{plan.price}</span>
                  <span className="text-sm font-helvetica font-normal leading-6 text-white/80">/project</span>
                </p>
                  ...
                  {plan.features.map((feature) => (
                    <li key={feature} className="flex gap-x-3">
                      <Check
                        ...
                        aria-hidden="true"
                      />
                      <span className="font-helvetica text-white">{feature}</span>
                    </li>
                  ))}
                </ul>
              </div>

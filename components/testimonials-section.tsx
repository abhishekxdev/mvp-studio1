          ...
          <div className="relative mt-16 w-full">
            ...
            >
              <div className="relative">
                ...
                <div className="p-8 md:p-12 rounded-xl border border-white/20 hover:bg-white/5 transition-all duration-300 backdrop-blur-sm">
                  <div className="relative">
            ...
            <div className="flex justify-start mt-8 gap-4">
              <Button 
                variant="outline" 
                size="icon" 
                className="rounded-full h-10 w-10 border-white/20 hover:bg-white/5 text-white"
                onClick={handlePrev}
              >
